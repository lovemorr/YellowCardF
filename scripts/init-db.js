...
async function initDb() {
  ...
  try {
    // Create yellow_card_policies table
    await sql`
    ...
    `;
    console.log('✓ yellow_card_policies table created');
    ...
    // Create indexes
    await sql`CREATE INDEX IF NOT EXISTS idx_yellow_card_number ON yellow_card_policies(yellow_card_number)`;
